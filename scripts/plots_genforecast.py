...
def plot_crps(
    ...
    dataset_labels=("LDCAST"),
    xticks=(0,30,60),
    log=(False, False, False, False),
    out_fn="../figures/crps-leadtime_11-18_0947.pdf",
    crop_box=None
):
...
def plot_rank(
    ...
    dataset_labels=("TCIR"),
    out_fn="../figures/rank-distribution_11-14_1627.pdf",
    crop_box=None
):
    N_modelsets = len(model_sets)
    N_scales = len(scales)
...
def plot_fss(
    thresholds=("0.1","0.3" ,"1.0", "10.0"),
    model_sets=(
            ("pm-{T}-pysteps"),
    ),
    dataset_labels=("TCIR"),
    xticks=(1, 50, 100, 150, 200),
    out_fn="../figures/pysteps_fss-threshold-1114_1627.pdf",
    crop_box=None
):
    N_modelsets = len(model_sets)
